const AgreementPageData = [
  {
    title:
      "cosMost 이용약관, 개인정보 수집 및 이용, 위치기반서비스 이용약관(선택), 프로모션 정보 수신(선택)에 모두 동의합니다.",
    state: "allCheck",
    content: null,
  },
  {
    title: "cosMost 이용약관 동의(필수)",
    state: "useCheck",
    content: `여러분을 환영합니다.
  ...
  },
  {
    ...
    state: "privacyCheck",
    content: `개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
  ...
  {
    title: "위치기반서비스 이용약관 동의(필수)",
    state: "locationCheck",
    content: `위치기반서비스 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 네이버 위치기반 서비스를 이용할 수 있습니다.
...
export default AgreementPageData;

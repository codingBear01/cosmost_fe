...
function InputEmailForm({ beforeEditUserInfo, type }) {
  /* Path */
  ...
  //   const url = `${process.env.REACT_APP_AUTH_IP}/v1/authorization/code/confirm/${certificationNumberRef.current.value}/${emailRef.current.value}`;
